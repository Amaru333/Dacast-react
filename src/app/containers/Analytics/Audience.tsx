...
import { AccountAnalyticsAudienceState, AccountAnalyticsParameters, AccountAudienceDimension, TimeRangeAnalytics } from '../../redux-flow/store/Analytics/Audience/types'
        ...
        <React.Fragment>
            <div className="flex mb2">
                <DateFilteringAnalytics
                    ...
                    callback={(info) => {  info.endDate && info.startDate ?  setTimeRangePick(  {timeRange: info.value as TimeRangeAnalytics, custom: info.value === "CUSTOM" ?  { start: info.startDate, end: info.endDate} : timeRangePick.custom } ) : null } }
                />
            </div>
            {
            props.audience.data ?
