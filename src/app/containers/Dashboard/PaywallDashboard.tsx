        ...
        <section className={classTopContainer}>
            <div className="flex items-baseline mb1">
                ...
                <Text size={24} weight="reg" className="mt0 inline-block">
                    {t('common_navigation_bar_menu_item_paywall')}
                </Text>
            </div>
            ...
            <div className={classContainer}>
                <WidgetElement placeholderWidget={paywallDataFetching} className={classItemHalfWidthContainer}>
                    <WidgetHeader className="flex">
                        ...
                        <div className="relative ml-auto">
                            <IconStyle id="balanceTooltip">info_outline</IconStyle>
                            <Tooltip target="balanceTooltip" style={{whiteSpace: 'nowrap'}}>{t('dashboard_balance_widget_description')}</Tooltip>
                        </div>
                    </WidgetHeader>
                ...
                <WidgetElement placeholderWidget={paywallDataFetching} className={classItemHalfWidthContainer}>
                    <WidgetHeader className="flex">
                        ...
                        <div className="relative ml-auto">
                            <IconStyle id="revenueTooltip">info_outline</IconStyle>
                            <Tooltip target="revenueTooltip" style={{whiteSpace: 'nowrap'}}>{t('dashboard_revenue_widget_description')}</Tooltip>
                        </div>
                    </WidgetHeader>
