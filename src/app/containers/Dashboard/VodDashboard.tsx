                ...
                <WidgetElement placeholderWidget={vodDataFetching} className={itemClass}>
                    <WidgetHeader className="flex">
                        ...
                        <div className="relative ml-auto">
                            <IconStyle id="totalVideosTooltip">info_outline</IconStyle>
                            <Tooltip target="totalVideosTooltip" style={{whiteSpace: 'nowrap'}}>{t('dashboard_number_of_videos_widget_description')}</Tooltip>
                        </div>
                    </WidgetHeader>
                    ...
                    <>
                        <WidgetElement placeholderWidget={vodDataFetching} failed={typeof props.profile.impressions === "undefined"}  className={itemClass}>
                            <WidgetHeader className="flex">
                                ...
                                <div className="relative ml-auto">
                                    <IconStyle id="impressionsTooltip">info_outline</IconStyle>
