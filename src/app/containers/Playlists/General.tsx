...
const GeneralPlaylist = (props: GeneralComponentProps) => {
    ...
    React.useEffect(() => {
        if(props.contentDetailsState['playlist']){
            setStateContentDetails(props.contentDetailsState['playlist'][playlistId])
            setContentDetails(props.contentDetailsState['playlist'][playlistId])
        }
            ...
            { props.contentDetailsState['playlist'] && stateContentDetails ?
                (
                    <div className='flex flex-column'>
                        ...
                        {
                            previewModalOpen && <PreviewModal contentId={userId + "-playlist-" + stateContentDetails.id} toggle={setPreviewModalOpen} isOpened={previewModalOpen} />
                        }
