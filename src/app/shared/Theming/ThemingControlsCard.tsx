...
import { ControlsCard, TitleSection, TextStyle, BorderStyle, ControlToggleContainer } from './ThemingStyle';
...
export const ThemingControlsCard = (props: {selectedTheme: ThemeOptions, setSelectedTheme: Function}) => {
            ...
            <TitleSection className="justify-center">
                            ...
                            </TitleSection>
                            {
                                ...
                                <>
                                    ...
                                    <InputRadio name='delevery-method' value='compatible-delivery' label='Compatible Delivery' defaultChecked={props.selectedTheme.deliveryMethod === 'compatible'} onChange={() => {props.setSelectedTheme({...props.selectedTheme, deliveryMethod:'compatible'});}}/>
                                    <InputRadio name='delevery-method' value='secure-delivery' label='Secure Delivery' defaultChecked={props.selectedTheme.deliveryMethod === 'secure'} onChange={() => {props.setSelectedTheme({...props.selectedTheme, deliveryMethod: 'secure'});}} />
                                    <BorderStyle className="p1" />
                                    ...
                                    <InputRadio name='region-settings' value='standard' label='Standard PoPs' defaultChecked={props.selectedTheme.regionSettings === 'standard'} onChange={() => {props.setSelectedTheme({...props.selectedTheme, regionSettings: 'standard'});}} />
                                    <InputRadio name='region-settings' value='premium' label='Premium PoPs' defaultChecked={props.selectedTheme.regionSettings === 'premium'} onChange={() => {props.setSelectedTheme({...props.selectedTheme, regionSettings: 'premium'});}} /> 
                                </>
                                    :
                                <>
