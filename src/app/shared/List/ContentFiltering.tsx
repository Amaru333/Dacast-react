            ...
            <Filtering isOpen={openFilters} >
                <div>
                    ...
                    <div className="mb3" id="contentFilterAfter">
                        ...
                        <DateSinglePickerWrapper id='startDate' date={isNaN(filteringState.afterDate as any) ? null : new Date(filteringState.afterDate as number)} allowOustsideDate callback={(date: Date) => { setFilteringState(prevState => { return { ...prevState, afterDate: date.getTime() } }) }} />
                    </div>
                    <div className="mb3" id="contentFilterBefore">
                        ...
                        <DateSinglePickerWrapper id='endDate' date={isNaN(filteringState.beforeDate as any) ? null : new Date(filteringState.beforeDate as number)} allowOustsideDate callback={(date: Date) => { setFilteringState(prevState => { return { ...prevState, beforeDate: date.getTime() } }) }} />
                    </div>
                    {
