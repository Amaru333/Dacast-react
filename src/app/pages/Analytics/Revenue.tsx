...
import { AnalyticsCard, renderMap, handleRowIconType, DateFilteringAnalytics } from './AnalyticsCommun';
    ...
    return (
        <React.Fragment>
            <div className="col col-12 mb25">
                <DateFilteringAnalytics refreshData={()=>{console.log("refresh data here")}} />
            ...
            <div className="clearfix mxn1 mb2">
                ...
                <div className="col col-4 px1">
                    <AnalyticsCard infoText="What devices are your viewers using? Data collected starting 07/29/2018. Data is tracked on the default player only." title="Sales per Country">
                        {renderMap(mapData, 'revenueAnalyticsDevices')}
                    </AnalyticsCard>
                </div>
            </div>
        </React.Fragment >
