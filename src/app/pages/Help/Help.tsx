            ...
            <div className="col col-12 flex mt2">
                <SmallHelpCard className="mr2 col col-4 flex p2">
                    <HelpCardHeader className="col col-12">
                        ...
                        <HelpPageIcon className="ml2">live_help</HelpPageIcon>
                    </HelpCardHeader>
                    <div className="col col-12 flex mt2">
                        <HelpCardContent>
                ...
                <SmallHelpCard className="mr2 col col-4 flex p2">
                    <HelpCardHeader className="col col-12">
                        ...
                        <HelpPageIcon className="ml2">find_in_page</HelpPageIcon>
                    </HelpCardHeader>
                    <div className="col col-12 flex mt2">
                        <HelpCardContent>
                ...
                {/* <SmallHelpCard className="mr2 col col-3 flex p2">
                    <HelpCardHeader className="col col-12">
                        ...
                        <HelpPageIcon className="ml2">import_contacts</HelpPageIcon>
                    </HelpCardHeader>
                    <div className="col col-12 flex mt2">
                        <HelpCardContent>
                ...
                <SmallHelpCard className="col col-4 flex p2">
                    <HelpCardHeader className="col col-12">
                        ...
                        <HelpPageIcon className="ml2">bookmark</HelpPageIcon>
                    </HelpCardHeader>
                    <div className="col col-12 flex mt2">
                        <HelpCardContent>
            ...
            <div className="col col-12 flex mt2">
                <LargeHelpCard className="mr2 col col-4 p2 flex">
                    ...
                    <CardPlaceholder className="flex col col-1 items-center">
                        <HelpPageIcon fontSize="large" className="ml2">email</HelpPageIcon>
                    </CardPlaceholder>
                </LargeHelpCard>
                ...
                <LargeHelpCard className="mr2 col col-4 p2 flex">
                    ...
                    <CardPlaceholder className="flex col col-1 items-center">
                        <HelpPageIcon fontSize="large" className="ml2">chat</HelpPageIcon>
                    </CardPlaceholder>
                </LargeHelpCard>
                ...
                <LargeHelpCard className="col col-4 p2 flex">
                    ...
                    <CardPlaceholder className="flex col col-1 items-center">
                        <HelpPageIcon fontSize="large" className="ml2">phone</HelpPageIcon>
                    </CardPlaceholder>
                </LargeHelpCard>
            </div>
        </React.Fragment>
