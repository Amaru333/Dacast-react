...
export const PlanStepperFourthStep = (props: { stepperData: Plan; updateStepperData: Function; setStepValidated: Function; finalFunction: Function; usefulFunctions: { [key: string]: any } }) => {
    ...
    return (
        <div>
            ...
            <NewPaymentMethodForm callback={() => console.log()} actionButton={props.finalFunction} purchasePlan={props.usefulFunctions['purchasePlan']} handleThreeDSecureFail={props.usefulFunctions['handleThreeDSecureFail']} stepperData={props.stepperData} />
