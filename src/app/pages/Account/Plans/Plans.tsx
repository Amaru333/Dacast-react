                        ...
                        <PlanContainer className={marginBlocks} style={{maxWidth: 275}}>
                            ...
                            <PlanCard className='mt1' isSelected={currentPlan === "scale"}>
                                <PlanInfosContainer isMobile={isMobile}>
                                    ...
                                    <DropdownButton className="ml1" id='scalePlanDropdown' list={['Annually', 'Monthly']} callback={(value: 'Annually' | 'Monthly') => setPlanBillingFrequency(value)} dropdownDefaultSelect={planBillingFrequency}  />
                                    </div>
