...
export const PaymentMethodModal = (props: {toggle: Function; actionButton: Function; callback: Function; billingInfo: BillingPageInfos; isUpdate: boolean}) => {

    return (
        <React.Fragment>
            <NewPaymentMethodForm billingInfo={props.billingInfo} callback={props.callback} actionButton={props.actionButton} isUpdate={props.isUpdate}/>
