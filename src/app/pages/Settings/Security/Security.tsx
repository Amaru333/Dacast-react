            ...
            <Card>
                <form id='settingsPageForm' onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className='col col-12 mb1'>
                        <Toggle id="passwordProtectedVideosToggle" label='Password Protection' 
                            name='passwordProtectedVideo.enabled'
                            refForwarded={register()}
                        />
                        ...
                        {
                            getValues({nest: true}).passwordProtectedVideo.enabled &&
                                <div className='col col-12 mb1'>
                                    <Input
                                        type='text'
                                        className='col col-4 md-col-3  '
                                        id='password'
                                        label='Password'
                                        placeholder='Password'
                                        {...handleValidationForm('passwordProtectedVideo.password', errors)}
                    ...
                    <div className='col col-12'>
                        ...
                        <Toggle id="videoScheduling" label='Content Scheduling' 
                            name='videoScheduling.enabled'
                            refForwarded={register()} 
                        />
                        ...
                        {
                            getValues({nest: true}).videoScheduling.enabled &&
                                <>
                                    <div className='col col-12 flex items-center'>
                                        ...
                                        { startDateTime === "Set Date and Time" &&
                                            ...
                                            <Input
                                                ...
                                                id='startTime'
                                                pattern="[0-9]{2}:[0-9]{2}"
                                                {...handleValidationForm('videoScheduling.startTime', errors)}
                                                ref={register()}
                                            /></>
                                        }
                                    </div>
                                    <div className='col col-12 flex items-center'>
...

                                        {
                                            endDateTime === "Set Date and Time" ?
                                                <>
                                                     <input type="hidden" ref={register()} name="videoScheduling.endDate" />
                                                    <DateSinglePickerWrapper 
                                                        callback={(date: string, ms: number) => { setValue('videoScheduling.endDate', ms) }} 
                                                        className='col col-4 md-col-3 mt2' />
                                                    <Input
                                                        type='time'
                                                        defaultValue={'00:00:00'}
                                                        ...
                                                        id='endTime'
                                                        pattern="[0-9]{2}:[0-9]{2}"
                                                        {...handleValidationForm('videoScheduling.endTime', errors)}
                                                        ref={register()} />
                                                </> : null
                                        }
                                    </div>
