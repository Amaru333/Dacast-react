                                    ...
                                    {startDateTime === "Set Date and Time" &&
                                        <>
                                            ...
                                            <DropdownSingle 
                                                ...
                                                callback={(value: string) => {setDisplayformActionButtons(true);setStartDateTimeValue({...startDateTimeValue, timezone: value})}} 
...

                                    {
                                        ...
                                        <>
                                            ...
                                            <DropdownSingle 
                                                ...
                                                className='col col-3 px2 mb2' 
                                                dropdownTitle='Timezone' 
                                                callback={(value: string) => {setDisplayformActionButtons(true);setEndDateTimeValue({...endDateTimeValue, timezone: value })}} 
                                                list={momentTZ.tz.names().reduce((reduced: DropdownListType, item: string) => {return {...reduced, [item + ' (' + momentTZ.tz(item).format('Z z') + ')']: false}}, {})} 
                                            />
                                        </>
                                    }
