...
export const InteractionsPage = (props: SettingsInteractionComponentProps) => {
    ...
    const dropdownList: DropdownSingleListItem[] = [{title: "Top Left"}, {title: "Top Right"}, {title: "Bottom Left"}, {title: "Bottom Right"}]
            ...
            <Card className="my2">
                ...
                <div className="lg-col lg-col-12 mb1 flex">
                    ...
                    <div className="col col-6">
                        <DropdownSingle className="col col-4 pr2" id="brandImagePlacementDropdown" dropdownTitle="Image Placement" list={dropdownList} dropdownDefaultSelect={props.interactionsInfos.brandImageSettings.brandImagePosition || 'Top Right'}
                        callback={(item: DropdownSingleListItem) => {setInteractionsInfos({...interactionInfos, brandImageSettings: {...interactionInfos.brandImageSettings, brandImagePosition: item.title}});setSettingsEdited(true)}}></DropdownSingle>
