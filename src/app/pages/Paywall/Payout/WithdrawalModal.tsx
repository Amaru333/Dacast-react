    ...
    return (
        <div>
            <div className='col col-12 my2'>
                ...
                />
                <Input className='col xs-no-gutter col-12 sm-col-4 pl1 mb1' id='withdrawalModalAmountInput' label='Withdrawal Amount (USD)' placeholder='100' onChange={(event) => setwithdrawalRequest({ ...withdrawalRequest, amount: parseInt(event.currentTarget.value) })} />
            </div>
            <div className=' col col-12 flex flex-column'>
                <div className='col col-12 sm-col-8 pr1'>
