...
export const DeliveryAndEmbed = () => {
    return (
        ...
        <Card>
            ...
            <br/>
            <div>
                <InputRadio name="delivery" label="Compatible Delivery" />
                <RadioText>
                    <Text size={14} weight="reg">
                ...
                <InputRadio name="delivery" label="Secure Delivery" />
            ...
            <br/>
            <div>
                <InputRadio name="region-settings" label="Standard PoPs" />
                <RadioText>
                    <Text size={14} weight="reg">
                ...
                <InputRadio name="region-settings" label="Premium PoPs" />
                <RadioText><Text size={14} weight="reg">
            ...
            <br/>
            <div>
                <InputRadio name="embed-settings" label="IFrame (Recommended)" />
                <RadioText>
                    <Text size={14} weight="reg">
                ...
                <InputRadio name="embed-settings" label="HTML5 Video" />
                <RadioText><Text size={14} weight="reg">
            ...
            <br/>
            <div>
                <InputRadio name="embed-protocol" label="HTTPS (Recommended)" />
                <RadioText>
                    <Text size={14} weight="reg">
            ...
            <br/>
            <div>
                <InputRadio name="embed-size" label="Responsive (Recommended)" />
                <RadioText>
                    <Text size={14} weight="reg">
                    Your embed codes will default to responding to the size of their container.
                    </Text>
                </RadioText>
                <InputRadio name="embed-size" label="Fixed" />
                <RadioText><Text size={14} weight="reg">
