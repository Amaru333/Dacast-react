    ...
    .add('Large button', () => (
        <React.Fragment>
            <div className="m3">
                ...
                <Button isLoading={true} buttonColor='blue' onClick={action("button-click")} sizeButton="large" typeButton="primary" className="mr1"  >Loading</Button>
            ...
            <div className="m3">
                ...
                <Button isLoading={true} buttonColor='blue' onClick={action("button-click")} sizeButton="large" typeButton="primary" className="mr1" disabled  >Disabled Loading</Button>
            ...
            <div className="m3">
                ...
                <Button isLoading buttonColor='red' onClick={action("button-click")} sizeButton="large" typeButton="primary" className="mr1"  >Loading</Button>
            ...
            <div className="m3">
                ...
                <Button isLoading={true} colorObject={buttonArrayColor['gray']} onClick={action("button-click")} sizeButton="large" className="mr1"  >Loading</Button>
            </div>
        </React.Fragment>
