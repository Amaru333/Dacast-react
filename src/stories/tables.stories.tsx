...
const tableHeader = [
    InputCheckboxComponent('checkbox0'),
    TextComponent({textstring:'ID', weight:'med'}),
    TextComponent({textstring:'Number', weight:'med'}),
    TextComponent({textstring:'Name', weight:'med'}),
    TextComponent({textstring:'Email', weight:'med'}),
    TextComponent({textstring:'Phone', weight:'med'}),
    TextComponent({textstring:'Status', weight:'med'}),
