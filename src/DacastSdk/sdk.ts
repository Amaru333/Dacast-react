...
export class DacastSdk {
    ...
    public postRegenerateApiKey = async (input: string): Promise<void> => await this.axiosClient.post(isProduction() ? GRAPHQL_API_BASE_URL_PROD : GRAPHQL_API_BASE_URL_STAGING + 'api_keys/regenerate', input)
