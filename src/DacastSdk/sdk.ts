...
export class DacastSdk {
    ...
    public postPurchaseAddOn = async (input: PostPurchaseAddOnInput): Promise<PostPurchaseaddOnOutput> => await this.axiosClient.post('/plan/purchase-add-on', input).then(this.checkExtraData)
