...
import { ActionTypes, presetsInitialState, VodPaywallPageInfos  } from "./types";

const reducer: Reducer<VodPaywallPageInfos> = (state = presetsInitialState, action: Action) => {
    let presets = null;
    let promos = null;
    switch (action.type) {
