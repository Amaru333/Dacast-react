...
export const InputCheckbox = (props: InputCheckboxProps) => {
    ...
    return (
        <ContainerStyle className={className} >
            <InputCheckboxStyle checked={props.checked} defaultChecked={props.defaultChecked} onFocus={() => setFocus(true)} onBlur={() => setFocus(false) }  {...other} type="checkbox" onClick={() => setChecked(!checked)} ref={checkboxRef} />
