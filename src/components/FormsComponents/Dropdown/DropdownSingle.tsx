...
export const DropdownSingle: React.FC<DropdownProps> = (props: DropdownProps) => {
    ...
    const [selectedItem, setSelectedItem] = React.useState<string>(props.dropdownDefaultSelect && props.dropdownDefaultSelect.title ? props.dropdownDefaultSelect.title.id : props.dropdownDefaultSelect ? props.dropdownDefaultSelect : "Select");
