...
export const Button = (props: ButtonProps) => {
    ...
    return <ButtonStyle colorObject={buttonArrayColor[props.buttonColor!]} {...other} disabled= {disabled || props.isLoading ? true : false } >{props.children}{ props.isLoading && <LoadingSpinner className="ml1" color='white' size={'xs'} />}</ButtonStyle>;
